...
function ProfileManager:ShowConfirmDialog(title, message, onConfirm)
    local dialog = Interface:CreateStyledWindow(title, 315, 100, true)
    dialog:SetFrameStrata("TOOLTIP")
    
    -- Message
    local messageText = dialog:CreateFontString(nil, "OVERLAY", "GameFontNormal")
    messageText:SetPoint("TOPLEFT", dialog, "TOPLEFT", 20, -30)
    messageText:SetPoint("TOPRIGHT", dialog, "TOPRIGHT", -20, -30)
    ...
    yesBtn:SetWidth(60)
    yesBtn:SetHeight(25)
    yesBtn:SetPoint("BOTTOM", dialog, "BOTTOM", -32, 10)
    yesBtn:SetText("Yes")
    ...
    noBtn:SetWidth(60)
    noBtn:SetHeight(25)
    noBtn:SetPoint("LEFT", yesBtn, "RIGHT", 5, 0)
    noBtn:SetText("No")
